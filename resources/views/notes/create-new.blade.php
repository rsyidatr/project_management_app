            ...
            <div class="p-5 border-b border-gray-100">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                        ...
                        <a href="{{ route('notes.create') }}" class="block w-full px-3 py-2.5 text-left text-sm text-gray-700 hover:bg-gray-50 rounded-b-lg bg-blue-50 text-blue-700 font-medium">
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col bg-white">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Add a new note to your collection</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-1 p-6 bg-gray-50 overflow-y-auto">
                <div class="max-w-3xl mx-auto">
                    <form action="{{ route('notes.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-100">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="goal" {{ old('type') == 'goal' ? 'selected' : '' }}>🎯 Goal</option>
                        ...
                        <div class="px-8 py-6 bg-gray-50 border-t border-gray-100 rounded-b-xl">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('notes.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors duration-200 font-medium">
                                        Cancel
                                    </a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('keydown', function(e) {
                ...
                if ((e.ctrlKey || e.metaKey) && e.key === 's') {
                    e.preventDefault();
                    const form = document.querySelector('form[action*="notes.store"]');
                    if (form) {
                        form.submit();
                    }
                }
